...
--1. Is there a growing trend in the no. of orders placed over the past years?-- 1. Is there a growing trend in the no. of orders placed over the past years?
--    (Monthly peaks across different years)
...
/*5. Analysis based on sales, freight and delivery time.
        ...
        days_to_deliver = order_delivered_customer_date -
...
/*6. Analysis based on the payments:
  1. Find the no. of orders placed using different payment
  types on month.
